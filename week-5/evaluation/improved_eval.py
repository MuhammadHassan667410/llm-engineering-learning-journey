...
# CHANGED: Import from improved_answer instead of answer
from implementation.improved_answer import answer_question, fetch_context

load_dotenv(override=True)

# Azure Configuration for the Judge
# We explicitly set these for LiteLLM to ensure it finds them
os.environ["AZURE_API_KEY"] = os.getenv("AZURE_OPENAI_API_KEY", "")
os.environ["AZURE_API_BASE"] = os.getenv("AZURE_OPENAI_ENDPOINT", "")
os.environ["AZURE_API_VERSION"] = os.getenv("AZURE_OPENAI_API_VERSION", "2024-02-15-preview")

# Deployment name for the judge (e.g. your gpt-4o-mini deployment)
azure_deployment = os.getenv("AZURE_OPENAI_DEPLOYMENT", "gpt-oss-120b")

# Check if keys are actually present
if not os.environ["AZURE_API_KEY"] or not os.environ["AZURE_API_BASE"]:
    print("CRITICAL ERROR: AZURE_OPENAI_API_KEY or AZURE_OPENAI_ENDPOINT missing in .env")

# We use the deployment string for LiteLLM/Azure
