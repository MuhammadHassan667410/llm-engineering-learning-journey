...
# CHANGED: Import from improved_eval to use improved_answer logic
from evaluation.improved_eval import evaluate_all_retrieval, evaluate_all_answers
...
def main():
    ...
    with gr.Blocks(title="Improved RAG Evaluation Dashboard", theme=theme) as app:
        gr.Markdown("# 📊 Improved RAG Evaluation Dashboard")
        gr.Markdown("Evaluate retrieval and answer quality for the Insurellm RAG system (Optimized Implementation)")
